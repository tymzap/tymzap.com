...
Each of these components would be used as children of the main `Button` component. Here's how it works:
...
The composition pattern lets you break down a complex component into smaller, independent parts that can be arranged in any order. This allows consumers of the component to easily include, remove, or modify its parts as needed. The main advantage of this pattern is that it gives you more control over the UI structure without requiring changes to the component's internal implementation. Try it out!